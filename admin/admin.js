  ...
  const sortBar = `
    ...
    <div class="admin-payment-subfilter">
      ...
      <div class="admin-payment-subfilter-row">
        ...
        <span class="admin-payment-subfilter-item ${adminPaymentSubFilter === 'shipping' ? 'active' : ''}" data-subfilter="shipping" role="button" tabindex="0">배송진행 ${shippingCount}개</span>
